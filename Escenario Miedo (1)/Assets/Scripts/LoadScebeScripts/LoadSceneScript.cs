    ...
    void Start()
    {
        ...
        switch (SceneMessenger.nextScene)
        {
            ...
            case 1:
                ...
                musicSource.Play();
                instructionText.text = "Encuentra las llaves de colores y úsalas en los lectores correspondientes para abrir las puertas.\r\nHalla la llave del pasillo final para escapar.\r\n\r\nBusca la linterna, es tu única arma. Su batería es limitada, pero puedes ahorrar energía presionando el botón B.\r\n\r\n⚠ ¡Cuidado con los peligros de la oscuridad!";
                oneShotSource.PlayOneShot(fearSound, 1f);
                break;
            case 2:
                instructionText.text = "Objetivo: mueve la pelota hacia la plataforma con el trofeo.\r\nAtención: debido a una falla en tu traje de teletransporte, no puedes tocar la pelota directamente. Usa el entorno para lograrlo.";
                oneShotSource.PlayOneShot(wrathSound, 1f);
                break;
            case 3:
                instructionText.text = "Explorador, en este escenario serás recompensado por compartir la felicidad con tu compañero.\r\nLlámalo presionando el botón B y juntos podrán jugar con una pelota.";
